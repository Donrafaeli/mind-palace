...
$popover-initial-transform-state: scale(0.9) translateZ(0) !default; // The inital transform state for the popover
...
// TRANSITIONS
$popover-transition-default-duration: 0 !default;
...
$popover-transition-default-timing-function: ease-in !default;
