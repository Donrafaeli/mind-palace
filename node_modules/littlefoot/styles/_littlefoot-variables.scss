...
$popover-color-background: #e7e7e7 !default;
...
// TRANSITIONS
$popover-transition-default-duration: 1.15s !default;
...
$popover-scroll-indicator-transition-properties: opacity !default;
$popover-scroll-up-transition-delay: 0.25s !default; // Sets the delay for the transition of the scroll indicator when scrolling upwards
...
$button-color: #248f79 !default; // Background color of the button
